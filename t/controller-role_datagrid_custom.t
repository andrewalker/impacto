...
my $datagrid_columns = [ qw/name supplier cost price/ ];
my $extra_params     = { supplier => { fk => 'supplier.person.name' } };

is_deeply($dg->datagrid_columns, $datagrid_columns, 'custom datagrid_columns are correct');
is_deeply($dg->datagrid_columns_extra_params, $extra_params, 'custom datagrid_columns_extra_params are correct');
